		...
		<div className="container mx-auto">
			...
			<div className="block sm:flex gap-0 sm:gap-10 mt-14">
				<div className="w-full sm:w-1/3 text-left">
								...
								(info) => {
									return (
										...
										>
											...
											{info.title === 'GitHub' ? (
												<a
													href={info.details.startsWith('http') ? info.details : 'https://' + info.details}
													target="_blank"
													rel="noopener noreferrer"
													className="hover:underline hover:text-primary dark:hover:text-accent cursor-pointer duration-300"
													aria-label="GitHub"
												>
													{info.details}
												</a>
					...
					{/* Single project social sharing / Links */}
					<div>
						<p className="font-general-regular text-2xl font-semibold text-ternary-dark dark:text-ternary-light mb-2">
						...
						<div className="flex items-center gap-3 mt-5">
							{props.project.github && (
								<a
									...
									target="_blank"
									rel="noopener noreferrer"
									className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 dark:bg-accent/10 text-primary dark:text-accent hover:bg-primary hover:text-white dark:hover:bg-accent dark:hover:text-primary-dark duration-300"
									aria-label="GitHub"
								>
